...
class dmZigbee extends dmUtils.DeviceManagement {
    ...
    async loadDevices(context) {
        if (this.adapter.connectionStatus) {
            const now = Date.now();
    ...
    async getDeviceDetails(id, _action, _context) {
        ...
        if (device.info.device.type != 'Coordinator') {
            ...
            techItems['type']      = { size:16, type: 'staticInfo',  label: 'Coordinator Hardware',       data: `${device.info.coordinatorData.type} ${device.info.coordinatorData.version} ${device.info.coordinatorData.revision}`,  newLine: true };
            techItems['sw']        = { size:16, type: 'staticInfo',  label: 'Coordinator Software',       data: device.info.coordinatorData.installedVersion,  addColon: true, newLine: true };
            ...
            techItems['ieee']      = { size:16, type: 'staticInfo',  label: 'Coordinator IEEE',           data: `${device.info.device.ieee}`,  addColon: true, newLine: true };
            techItems['port']      = { size:16, type: 'staticInfo',  label: 'Coordinator Connection',     data: `${device.info.coordinatorData.port}`,  addColon: true, newLine: true };

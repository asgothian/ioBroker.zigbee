...
class DeviceDebug extends basePlugin {
    ...
    start(statescontroller, zigbeecontroller) {
        ...
        this.stController?.on('device_debug', this.onDebugEvent.bind(this))
        this.adapter.on('device_debug', this.onDebugEvent.bind(this))
        this.zbController?.on('device_debug', this.onDebugEvent.bind(this))
        this.pluginName = 'DeviceDebug';
    }

    stop()
    {
        this.zbController.off('device_debug', this.onDebugEvent);
        this.stController.off('device_debug', this.onDebugEvent);
        super.stop();
    }

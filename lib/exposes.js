                ...
                case 'light': {
                    ...
                    if (hasColorXY || hasColorHS) {
                        ...
                        pushToStates({
                            ...
                            type: 'string',
                            setter: value => {
                                const rv = colors.complexColor(value, true, colors.capabilities(hasColorXY, hasColorHS));
                                if (rv) return rv;
                                // hex or named color
                                const rgbcolor = hasColorXY ? colors.ParseColor(value) : colors.ParseColorToHSV(value);
                                return rgbcolor;
                            },
                            setterOpt: (value, options) => {
                                const hasTransitionTime = options && options.hasOwnProperty('transition_time');
                            ...
                            getter: payload => {
                                return colors.complexColor(payload, false, colors.capabilities(hasColorXY, hasColorHS));
                            },
                            epname: expose.endpoint,
                            category: expose.category ?? 'color',
                            setattr: 'color',

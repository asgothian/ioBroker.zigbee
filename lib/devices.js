...
const statesLib = require(__dirname + '/states.js');
const states = statesLib.states;
const comb = statesLib.comb;
const sync = statesLib.sync;
...
const lightStatesWithColor = [states.state, states.brightness, states.colortemp, states.color, states.transition_time, states.color_xy];
const lightStatesWithColor_hue = [states.state, states.brightness, states.colortemp, states.color, states.transition_time, states.effect_type_hue, states.color_xy];
const lightStatesWithColorNoTemp = [states.state, states.brightness, states.color, states.transition_time, states.color_xy];
...
function fillStatesWithExposes(allExcludesObj, message) {
    const byModel = getByModel();

    applyExposes(devices, byModel, allExcludesObj, message);

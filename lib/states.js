...
*/
    ...
    color_xy: {
        ...
        getter: payload => {
            if (payload.color && payload.color.hasOwnProperty('x') && payload.color.hasOwnProperty('y')) {
                return `${payload.color.x},${payload.color.y}`;
            }
            return undefined;
        },
    },
...
const comb = {
    brightnessAndState: function brightnessAndState(state, value, options, disableQueue)
    {
    ...
    effectJson: function effectJson(state, value, options, disableQueue)
    {
